...
type ProductService interface {
	...
	GetCategoryList(parentId int64, limit int, start int) []models.Product
...
func (p productService) GetCategoryList(parentId int64, limit int, start int) []models.Product {
