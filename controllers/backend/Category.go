...
func (p *CategoryController) PostCreate() {
	...
	data := models.Category{Identifier: identifier, Thumb: thumb, MetaTitle: metaTitle, MetaKeywords: metaKeywords, MetaDescription: metaDescription, Title: title, Status: status, Content: template.HTML(content)}
	if postUuid == "" {
