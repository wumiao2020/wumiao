...
func (p *TagController) PostCreate() {
	...
	data := models.Tag{Identifier: identifier, Thumb: thumb, MetaTitle: metaTitle, MetaKeywords: metaKeywords, MetaDescription: metaDescription, Title: title, Status: Status, Content: template.HTML(content)}
	if postUuid == "" {
