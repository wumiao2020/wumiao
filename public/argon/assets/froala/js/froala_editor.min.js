...
!function (e, t) {
    ...
    V.RegisterPlugins = function (e) {
        ...
        function v(e, t, n) {
            ...
            return f.opts.fullPage && (r = f.html.extractNode(e, "body") || (0 <= e.indexOf("<body") ? "" : e), n && (o = f.html.extractNode(e, "head") || "")), r = C(r, t), o && (o = C(o, t)), function a(e) {
                return e = (e = (e = e.replace(/\[FROALA\.EDITOR\.SCRIPT ([\d]*)\]/gi, function (e, t) {
                    ...
                    var n = l[parseInt(t, 10)].replace(/&lt;/g, "<").replace(/&gt;/g, ">"), r = g(n);
                    if (r && r.length) {
                        var o = C(r.html(), L);
        ...
        return {
            _init: function e() {
                ...
                !function s() {
                    ...
                    for (var e = f.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
                        var n = e[t];
                        if (f.node.isFirstSibling(n) && "none" != n.parentNode.style.listStyleType) g(n).before("<br/>"); else if (n.previousSibling && "BR" === n.previousSibling.tagName) {
    ...
    V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), V.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", V.LinkRegExTLD = "((".concat(V.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), V.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(V.LinkRegExCommon, ")"), V.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(V.LinkRegExCommon, ")"), V.LinkRegExWWW = "(www\\.".concat(V.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), V.LinkRegEx = "(".concat(V.LinkRegExTLD, "|").concat(V.LinkRegExHTTP, "|").concat(V.LinkRegExWWW, "|").concat(V.LinkRegExAuth, ")").concat(V.LinkRegExEnd), V.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], V.MAIL_REGEX = /.+@.+\..+/i, V.MODULES.helpers = function (i) {
        ...
        function c(e) {
            ...
            if (l.selection.isCollapsed() && "" === l.html.get() && l.html.set(V.MARKERS), !l.core.hasFocus() && e) {
        ...
        return {
            ...
            }, on: h, trigger: C, bindClick: function r(e, t, n) {
        ...
        return {
            _startEnter: function b(e) {
                var t, n = C(e), r = n.nextSibling, o = n.previousSibling, i = g.html.defaultTag();
                ...
                for (var t = C(e), n = V.MARKERS, r = "", o = e, i = !1; o !== t;) if (!(o = o.parentNode).classList.contains("fr-img-space-wrap") && !o.classList.contains("fr-img-space-wrap2")) {
                ...
                if (r) {
                    ...
                    if (s === g.el) return !1;
                    if (s = s.nextSibling, g.node.isBlock(s)) V.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (m(e).replaceWith(V.MARKERS), (t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(n).append(m(s).html()), m(s).remove()); else {
        ...
        function v(e) {
            ...
            n = n.previousSibling;
            var r = h.opts.htmlAllowedEmptyTags, o = n.tagName && n.tagName.toLowerCase();
            if ((!h.node.isBlock(n) || n.lastChild && o && 0 <= r.indexOf(o)) && h.node.isEditable(n)) {
                ...
                if (n.nodeType === Node.TEXT_NODE) {
                    ...
                    if (0 === n.textContent.length) if (s && h.opts.keepFormatOnDelete) g(n).after(V.INVISIBLE_SPACE + V.MARKERS); else if (0 !== i.length && h.node.isBlock(n.parentNode)) g(n).after(V.MARKERS); else if ((2 != n.parentNode.childNodes.length || n.parentNode != e.parentNode) && 1 != n.parentNode.childNodes.length || h.node.isBlock(n.parentNode) || h.node.isElement(n.parentNode) || !h.node.isDeletable(n.parentNode)) {
                        for (var l, c = n; !h.node.isElement(n.parentNode) && h.node.isEmpty(n.parentNode) && V.NO_DELETE_TAGS.indexOf(n.parentNode.tagName) < 0;) if ("A" === (n = n.parentNode).tagName) {
                    ...
                    } else g(n.parentNode).after(V.MARKERS), g(n.parentNode).remove(); else g(n).after(V.MARKERS)
            ...
            } else if (V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (h.node.isEditable(n) || h.node.isDeletable(n))) if (h.node.isDeletable(n)) g(e).replaceWith(V.MARKERS), g(n).remove(); else if (h.node.isEmpty(n) && !h.node.isList(n)) g(n).remove(), g(e).replaceWith(V.MARKERS); else {
        ...
        function i(e) {
            var t = 0 < g(e).parentsUntil(h.$el, "BLOCKQUOTE").length, n = h.node.deepestParent(e, [], !t);
            ...
            if (null !== n) {
                ...
                if (h.node.isBlock(n) && (h.node.isEditable(n) || h.node.isDeletable(n)) && i && V.NO_DELETE_TAGS.indexOf(i.tagName) < 0) if (h.node.isDeletable(i)) g(i).remove(), g(e).replaceWith(V.MARKERS); else if (h.node.isBlock(i) && h.node.isEditable(i)) if (h.node.isList(i)) if (h.node.isEmpty(n, !0)) g(n).remove(), g(i).find("li").first().prepend(V.MARKERS); else {
        ...
        function n(e) {
            ...
            if ("BR" === (n = n.nextSibling).tagName && h.node.isEditable(n)) if (n.nextSibling) {
                ...
                if (p(e)) h.cursorLists._del(e); else h.node.deepestParent(n) && ((!h.node.isEmpty(h.node.blockParent(n)) || (h.node.blockParent(n).nextSibling && V.NO_DELETE_TAGS.indexOf(h.node.blockParent(n).nextSibling.tagName)) < 0) && g(n).remove(), i(e));
                return
            }
            ...
            } else if (V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (h.node.isEditable(n) || h.node.isDeletable(n))) if (h.node.isDeletable(n)) g(e).replaceWith(V.MARKERS), g(n).remove(); else if (h.node.isList(n)) e.previousSibling ? (g(n).find("li").first().prepend(e), h.cursorLists._backspace(e)) : (g(n).find("li").first().prepend(V.MARKERS), g(e).remove()); else if ((t = h.node.contents(n)) && "BR" === t[0].tagName && g(t[0]).remove(), t && "BLOCKQUOTE" === n.tagName) {
                var r = t[0];
        ...
        function b(e, t, n) {
            ...
            if (null === o) (r = h.html.defaultTag()) && h.node.isElement(e.parentNode) ? g(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : !e.previousSibling || g(e.previousSibling).is("br") || e.nextSibling ? g(e).replaceWith("<br>".concat(V.MARKERS)) : g(e).replaceWith("<br>".concat(V.MARKERS, "<br>")); else {
                var i = e, a = "";
        ...
        function L(e, t, n) {
            ...
            if (null === r) h.html.defaultTag() && e.parentNode === h.el ? g(e).replaceWith("<".concat(h.html.defaultTag(), ">").concat(V.MARKERS, "<br></").concat(h.html.defaultTag(), ">")) : (e.nextSibling && !h.node.isBlock(e.nextSibling) || g(e).after("<br>"), g(e).replaceWith("<br>".concat(V.MARKERS))); else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName) g(e).replaceWith("<" + h.html.defaultTag() + ">" + V.MARKERS + "<br></" + h.html.defaultTag() + ">"); else {
                var o = e, i = "";
                ...
                if ("BLOCKQUOTE" === r.tagName) if (e.previousSibling && h.node.isBlock(e.previousSibling) && e.nextSibling && "BR" === e.nextSibling.tagName && (g(e.nextSibling).after(e), e.nextSibling && "BR" === e.nextSibling.tagName && g(e.nextSibling).remove()), t) i = a + i + V.MARKERS + s; else {
        ...
        return {
            enter: function E(e) {
                ...
                0 < g(t).parentsUntil(h.$el, "BLOCKQUOTE").length && (r = !0), g(t).parentsUntil(h.$el, "TD, TH").length && (r = !1), d(t) ? !p(t) || e || r ? b(t, e, r) : h.cursorLists._endEnter(t) : f(t) ? !p(t) || e || r ? function l(e, t, n) {
                    ...
                    if (null === o) (r = h.html.defaultTag()) && h.node.isElement(e.parentNode) ? g(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : g(e).replaceWith("<br>".concat(V.MARKERS)); else {
                        if (r = h.html.defaultTag(), h.node.isBlock(o)) if ("PRE" === o.tagName && (t = !0), t) g(e).remove(), g(o).prepend("<br>".concat(V.MARKERS)); else if (e.nextSibling && "IMG" == e.nextSibling.tagName || e.nextSibling && e.nextSibling.nextElementSibling && "IMG" == e.nextSibling.nextElementSibling) g(e).replaceWith("<" + h.html.defaultTag() + ">" + V.MARKERS + "<br></" + h.html.defaultTag() + ">"); else {
                            if (h.node.isEmpty(o, !0)) return b(e, t, n);
                            if (h.opts.keepFormatOnDelete || "DIV" === o.tagName || "div" === h.html.defaultTag()) if (!h.opts.keepFormatOnDelete && "DIV" === o.tagName || "div" === h.html.defaultTag()) g(o).before("<" + h.html.defaultTag() + "><br></" + h.html.defaultTag() + ">"); else {
                ...
                if (h.$oel[0].offsetHeight > o) {
                    var i = h.helpers.scrollTop(), a = h.selection.blocks();
                ...
                return d(t) ? p(t) && u(t, g(t).parents("li").first().get(0)) ? h.cursorLists._backspace(t) : e = v(t) : f(t) ? p(t) && u(t, g(t).parents("li").first().get(0)) ? h.cursorLists._backspace(t) : function l(e) {
                    ...
                    if (null !== n) {
                        ...
                        if (h.node.isBlock(n) && h.node.isEditable(n)) if (a && V.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
                            if (h.node.isDeletable(a)) g(a).remove(), g(e).replaceWith(V.MARKERS); else if (h.node.isEditable(a)) if (h.node.isBlock(a)) if (h.node.isEmpty(a) && !h.node.isList(a)) g(a).remove(), g(e).after(h.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : ""); else {
                ...
                if (!e) return !1;
                if (h.el.normalize(), d(e)) if (p(e)) if (0 === g(e).parents("li").first().find("ul, ol").length) h.cursorLists._del(e); else {
        ...
        function m(e, t, n) {
            if (e) {
                ...
                if (e) {
                    ...
                    if (o) {
                        if (M(o).find(".fr-marker").length || "UL" === o.tagName || "OL" === o.tagName) m(o.firstChild, t, n); else if (T.browser.mozilla && T.node.hasClass(o, "fr-marker")) {
        ...
        function r(e, t) {
            ...
            !function y(e, t, n, r) {
                for (var o = T.node.contents(e.get(0)), i = 0; i < o.length; i++) {
                    var a = o[i];
                    if (a.innerHTML && 8203 == a.innerHTML.charCodeAt() && a.tagName.toLocaleLowerCase() == n && a.childNodes.length < 2 && (a.outerHTML = a.innerHTML), T.node.hasClass(a, "fr-marker")) t = (t + 1) % 2; else if (t) if (0 < M(a).find(".fr-marker").length) t = y(M(a), t, n, r); else {
        ...
        return {
            text: s, get: L, ranges: f, clear: S, element: function l() {
                ...
                var C = E.$el.find(".fr-marker").last().get(0), v = E.$el.find(".fr-marker").first().get(0);
        ...
        return {
            defaultTag: d, isPreformatted: s, emptyBlocks: i, emptyBlockTagsQuery: function E() {
                ...
                var t = O.clean.html((e || "").trim(), [], [], O.opts.fullPage), n = new RegExp("%3A//", "g"),
                    r = t.replace(n, "://");
                if (O.opts.fullPage) {
                    var o = m(r, "body") || (0 <= r.indexOf("<body") ? "" : r), i = C(r, "body"),
                        a = m(r, "head") || "<title></title>", s = C(r, "head"), l = h("<div>");
            ...
            }, checkIfEmpty: o, extractNode: m, extractNodeAttrs: C, extractDoctype: v, cleanBRs: function R() {
        ...
        function s(e) {
            ...
            p = !1;
            var r = b(n) && !C(e) && !e.altKey, o = n === V.KEYCODE.BACKSPACE || n === V.KEYCODE.DELETE;
            ...
            }(); else if (n !== V.KEYCODE.BACKSPACE || C(e) || e.altKey) if (n !== V.KEYCODE.DELETE || C(e) || e.altKey || e.shiftKey) n === V.KEYCODE.SPACE ? function l(e) {
                var t = d.selection.element();
            ...
            }(e) : C(e) || !b(e.which) || d.selection.isCollapsed() || e.ctrlKey || e.altKey || d.selection.remove(); else {
        ...
        return {
            ...
            }, ctrlKey: C, isCharacter: b, isArrow: v, forceUndo: function N() {
        ...
        function o(e, t, n) {
            ...
            }()) && (e = N.win.localStorage.getItem("fr-copied-html")), l) e = N.clean.html(e, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs); else {
        ...
        function c(e, t) {
            var n, r = function c(e, t) {
                ...
                return n
            }(e, t), o = d(u.doc.createElement("DIV"));
            ...
            if (0 < i.length) {
                var a = u.helpers.getPX(o.find(".fr-color-set > span").css("width")),
                    s = u.helpers.getPX(i.css("paddingLeft")), l = u.helpers.getPX(i.css("paddingRight"));
        ...
        function E(r) {
            ...
            return {
                _windowResize: function () {
                    ...
                    var t = o.data("instance") || u, n = d(e.currentTarget);
                    ...
                    if (!u.core.sameInstance(o)) return !0;
                    var t = o.data("instance") || u, n = e.which;
                    if (V.KEYCODE.ESC === n) {
                    ...
                    if (u.$wp && C(r) && o.parent().get(0) === u.$sc.get(0)) {
                        var e = o.offset().top - u.$wp.offset().top, t = u.$wp.outerHeight();
        ...
        return u.shared.exit_flag = !1, {
            ...
            }, hideAll: b, setContainer: m, refresh: function A(e) {
            ...
            }, isVisible: C, setFileListHeight: o, areVisible: v, setPopupDimensions: function w(e, t) {
        ...
        return {
            ...
            }, build: C, buildList: function L(e, t) {
            ...
            }, getButtons: m, getPosition: function M(e) {
            ...
            for (var e = m.$tb.find(".fr-more-toolbar"), c = "", t = 0; t < e.length; t++) {
                ...
                d.hasClass("fr-expanded") ? function () {
                    var n = m.helpers.getPX(d.css("padding-left")), e = d.find("> .fr-command, > .fr-btn-wrap"),
                        t = v(e[0]), r = m.helpers.getPX(t.css("margin-left")),
    ...
    h.fn = h.prototype = {
        constructor: h, length: 0, contains: function (e) {
            ...
            if (t) if ("string" == typeof t) for (var n = 0; n < this.length; n++) {
                ...
                var o = this[0];
                if (o.nextSibling) if (t instanceof h) for (var i = 0; i < t.length; i++) o.nextSibling.parentNode.insertBefore(t[i], o.nextSibling); else o.nextSibling.parentNode.insertBefore(t, o.nextSibling); else C(o.parentNode).append(t)
            }
            return this
        }, clone: function (e) {
